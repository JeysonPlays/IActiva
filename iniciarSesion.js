...
function Login() {
  ...
  const showSplash = submitting || !ready || !!loadingText;
  const splashMsg = submitting ? "Entrando..." : loadingText || "Cargando...";
    ...
    showSplash
      ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("span", { className: "splash-text" }, splashMsg)
          )
        )
      : null,
    React.createElement(
